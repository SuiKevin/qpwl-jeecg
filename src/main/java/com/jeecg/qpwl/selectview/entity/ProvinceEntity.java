...
public class ProvinceEntity implements java.io.Serializable {
	...
	private java.lang.String provibcecode;
	...
	@Column(name ="PROVIBCECODE",nullable=true,length=50)
	public java.lang.String getProvibcecode(){
		return this.provibcecode;
	}
	 ...
	 */
	public void setProvibcecode(java.lang.String provibcecode){
