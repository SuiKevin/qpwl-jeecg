 ...
 *
 */
public class JianliOnlinePage implements java.io.Serializable {
	/**主键*/
    ...
    /**简历被查看的次数 */
    private java.lang.String lookNum;
    
    /**是否已经获取过该简历的联系方式*/
    private java.lang.String isMyLook;
	...
	private List<JinaliZhengshuEntity> jinaliZhengshuList = new ArrayList<JinaliZhengshuEntity>();
		public List<JinaliZhengshuEntity> getJinaliZhengshuList() {
		return jinaliZhengshuList;
		}
		public void setJinaliZhengshuList(List<JinaliZhengshuEntity> jinaliZhengshuList) {
		this.jinaliZhengshuList = jinaliZhengshuList;
		}
	/**保存-学历教育*/
    @ExcelCollection(name="学历教育")
	private List<JianliJiaoyuEntity> jianliJiaoyuList = new ArrayList<JianliJiaoyuEntity>();
		public List<JianliJiaoyuEntity> getJianliJiaoyuList() {
		return jianliJiaoyuList;
		}
		public void setJianliJiaoyuList(List<JianliJiaoyuEntity> jianliJiaoyuList) {
		this.jianliJiaoyuList = jianliJiaoyuList;
		}
	/**保存-工作经验*/
    @ExcelCollection(name="工作经验")
	private List<JianliJingyanEntity> jianliJingyanList = new ArrayList<JianliJingyanEntity>();
		public List<JianliJingyanEntity> getJianliJingyanList() {
		return jianliJingyanList;
		}
		public void setJianliJingyanList(List<JianliJingyanEntity> jianliJingyanList) {
		this.jianliJingyanList = jianliJingyanList;
		}
	/**保存-积分消费情况*/
	 ...
	 * @return
	 */
	public java.lang.String getLookNum() {
		return "".equals(lookNum)?"0":lookNum;
	}

	public void setLookNum(java.lang.String lookNum) {
		if("".equals(lookNum)){
			this.lookNum = "0";
		}else{
	...
	public java.lang.String getIsMyLook() {
		return isMyLook;
	}

	public void setIsMyLook(java.lang.String isMyLook) {
		this.isMyLook = isMyLook;
	}
