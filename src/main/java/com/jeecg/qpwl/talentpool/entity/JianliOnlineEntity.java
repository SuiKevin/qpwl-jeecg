 ...
 * @date 2017-12-29 18:04:43
 * @version V1.0   
 *
 */
@Entity
@Table(name = "jianli_online", schema = "")
@SuppressWarnings("serial")
public class JianliOnlineEntity implements java.io.Serializable {
	/**主键*/
	...
	/**性别*/
    @Excel(name="性别",width=15,dicCode="bpm_status")
	...
	@Column(name ="JOBTYPE2",nullable=true,length=20)
	...
	@Column(name ="ZWPJ",nullable=true,length=600)
	...
	@Column(name ="GXSJ",nullable=true,length=32)
	public java.lang.String getGxsj(){
		return this.gxsj;
	}
	 ...
	 */
	public void setGxsj(java.lang.String gxsj){
		this.gxsj = gxsj;
	}
	...
	@Column(name ="LRSJ",nullable=true,length=32)
	...
	@Column(name ="SFLRSJ",nullable=true,length=32)
