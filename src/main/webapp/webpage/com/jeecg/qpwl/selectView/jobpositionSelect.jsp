...
<t:datagrid  pagination="false"  name="jobpositionList" title=""  actionUrl="jobpositionController.do?datagrid" idField="positionid" checkbox="true" showRefresh="false"  fit="true"  queryMode="group" onLoadSuccess="initCheck">
