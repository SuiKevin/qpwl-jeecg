...
<t:datagrid  pagination="false"  name="jobList" title=""  actionUrl="jobController.do?datagrid" idField="jobid" checkbox="true" showRefresh="false"  fit="true"  queryMode="group" onLoadSuccess="initCheck">
